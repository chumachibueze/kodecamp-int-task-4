                ...
                userlist.map((userprofile) => (
                  <div className="col-md-6 col-sm-12" key={userprofile.id}>
                    <div className=' px-5 pt-3 pb-2 mb-5 profile-container'>
                      <h1 className="name-header fw-bolder ps-lg-5 ps-md-0 ps-sm-0"> {userprofile.name}</h1>
                      <p className="user-text pt-2 mb-5 ps-lg-5 ps-md-0 ps-sm-0">I'm a disigner in love with photography, 
                      painting and discovering new worlds and cultures.
                      </p>
                      <div className="info-container ps-lg-5 ps-md-0 ps-sm-0">
